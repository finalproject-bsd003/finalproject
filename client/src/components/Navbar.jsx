  ...
  return (
    <>
      <div className="w-full top-0 z-28 flex items-center justify-between bg-[#DDD9CE] ">
        {/* <NavLink to={"/"}> */}
        <div >
          <img onClick={logoClick} src={logo} style={{ width: "80px", height: "70px", marginBottom: "10px" }} />
        </div>
        {/* </NavLink> */}

        <div style={{ position: "sticky", top: "20px", left: "50%", transform: "translateX(-50%)", zIndex: "1" }}>
          {/* Grade button */}
            ...
            <button className="dropdown mx-8 z-10">
              <details open={dropdownOpenStore}>
                ...
                >
                  {stores?.map((el) => (
                    <li key={el.id}>
                      <a onClick={(e) => handleStoreClick(e, el.id)}>{el.name}</a>
                    </li>
                  ))}
                </ul>
              </details>
          ...
          {isCollapsed ? (
            <div className="relative mx-auto w-96">
              ...
              >
                ...
                <button onClick={handleStartStopClick} className="mr-2">
                  {isListening ? (
                    ...
                    >
                      ...
                      {isListening && <circle cx="12" cy="12" r="5" fill="red" />}
                ...
                {/* <span style={{ visibility: 'hidden' }}>{listening ? 'Listening...' : ''}</span> */}
              </button>
              <button
